...
function _getValidName(interfaceName) {
  var numberOfSameNameInterfaces = interfaces.filter(function (x) {
    ...
    return _toSafeKey((_x$name = x.name) === null || _x$name === void 0 ? void 0 : _x$name.toUpperCase()) === _toSafeKey(interfaceName.toUpperCase());
  }).length;
...
function _toSafeKey(text) {
  var containsIllegalChars = text.match(/-+|@+|\/+/mg);
