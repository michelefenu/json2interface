...
function _getType(propertyName, propertyValue) {
  if (_isPrimitiveType(propertyValue)) return _typeof(propertyValue);else if (Array.isArray(propertyValue)) return "".concat(_toPascalCase(propertyName), "[]");else return _toPascalCase(propertyName);
}
/**
